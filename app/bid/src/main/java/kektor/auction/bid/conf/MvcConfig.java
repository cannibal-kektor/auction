...
//        task:
//            scheduling:
//                threadNamePrefix: Auction-Scheduling-Thread-
//                pool:
//                    size: 1
//                shutdown:
//                    await-termination: true
...
//                .awaitTerminationPeriod(shutdown.getAwaitTerminationPeriod())
//                .threadNamePrefix(properties.getThreadNamePrefix())
//                .customizers(taskSchedulerCustomizers)
//                .build();
//
//    }

// можем также конфигурировать через SchedulingConfigurer
//    @EnableScheduling
...
//        //Jackson2ObjectMapperBuilder - builder из которого строиться ObjectMapper
//        //Проще всего конфигурировать через Jackson2ObjectMapperBuilderCustomizer(настройки добавятся к дефолтным)
...
//
//    @Bean
//    public SortHandlerMethodArgumentResolverCustomizer sortCustomizer(SpringDataWebProperties properties) {
