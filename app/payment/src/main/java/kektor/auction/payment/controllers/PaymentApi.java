...
public class PaymentApi {
    ...
    public Callable<PaymentAccountDto> getBid(@PathVariable("accountId") @Positive Long accountId,
    ...
    public Callable<PaymentAccountDto> createAccount(@RequestParam("userId") @Positive Long userId) {
        return () -> paymentService.createAccount(userId);
    }

    @PostMapping(value = "/replenish", consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Callable<Void> commitReservation(@RequestParam("sagaId") @Positive Long sagaId) {
        return () -> {
            paymentService.commitReservation(sagaId);
            return null;
        };
    }

    @PostMapping(value = "/cancel")
    public Callable<Void> cancelReservation(@RequestParam("sagaId") @Positive Long sagaId) {
        return () -> {
